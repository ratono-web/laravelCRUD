...
<script src="{{url('js/color-modes.js')}}"></script>
    ...
    <meta name="description" content="Project UAS ">
    <meta name="author" content="Nur Khanifah">
    <meta name="generator" content="Hugo 0.122.0">
    <title>Web Data Alumni</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-8 col-md-7 py-4">
          ...
          <p class="text-body-secondary">Klik untuk Login.</p>
        </div>
        <div class="col-sm-4 offset-md-1 py-4">
          <h4><a href="{{ route('register') }}">Register</a></h4>
          <p class="text-body-secondary">Klik untuk registrasi</p>
        </div>
      </div>
    </div>
  </div>
